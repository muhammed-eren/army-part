...
<header>
  <title>Genel Ayarlar | SS Admin Paneli</title>
</header>
        ...
        <div class="x_panel">
          <div class="x_title">
            <h2>Genel Ayarlar <small>
              ...
              <?php if (isset($_GET['durum'])=="dosyaboyutu") { ?>
                  <b style="color:red">! Dosya boyutu 2MB'dan büyük !</b>
              <?php } ?>

              <?php if (isset($_GET['durum'])=="dosyauzanti") { ?>
                  <b style="color:red">! Bu dosya uzantısına izin verilmiyor !</b>
              <?php } ?>
            ...
            <form action="../netting/islem.php" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <?php 
                    //db'deki ayar_logo kısmındaki karakter sayısı 0'dan büyükse, yani dosya var ise
                ...
                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" name="logoduzenle" class="btn btn-primary">Yükle</button>
                </div>
