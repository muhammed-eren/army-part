...
<head>
  ...
  <meta name="description" content="Army part army part sign in ARMY PART">
...
<body>
    ...
    <header class="header__section">
                    ...
                    <div class="header__top--right d-flex align-items-center">
                        ...
                        ?>
                            <ul class="header__top--link d-flex align-items-center">
                                <li class="header__link--menu"><a class="header__link--menu__text text-white" href="login">
                                    <i class="fa-solid fa-right-to-bracket"></i> Login</a>
                                </li>
                                <li class="header__link--menu"><a class="header__link--menu__text text-white" href="register">
        ...
        <div class="main__header header__sticky" style="padding: 10px 120px;>
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index"><img class="main__logo--img" src="/image/catalog/logo_EFN.png" alt="logo-img"></a></h1>
                    </div>
                    <div class="header__menu style3 d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                <li class="header__menu--items">
                                    <a class="header__menu--link <?php if($page == '/index.php') { echo 'active'; } ?>" href="/qzu/index.php">Home 
                                    </a>
                                </li>
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link <?php if($page == '/shop.php') { echo 'active'; } ?>" href="/shop">Shop
                                    </a>
                                </li>
                                <li class="header__menu--items">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link <?php if($page == '/contact.html') { echo 'active'; } ?>" href="contact.html">Contact </a>  
                                </li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <ul class="header__account--wrapper d-flex align-items-center">
                                    ...
                                    <?php
                                        if(@$_SESSION['USER']) {
                                            $count = $db->query("
                                                ...
                                                FROM `wishlist` 
                                                WHERE `kullanici_id` = '{$_SESSION['USER']['kullanici_id']} and  1 = 1'
                                            ")->fetch(PDO::FETCH_ASSOC);
                                        }
                                    ?>
                                    <span class="items__count" id="wishlist_count"><?=$count['count'] ?? '?'?></span>
                            ...
                            <li class="header__account--items header__minicart--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <span class="items__count" id="cart_count">0</span> 
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="offCanvas__minicart">
            ...
            <div class="minicart__product">
                <div class="empty-cart" style="text-align:center; padding:20px; font-weight:bold; display:none;">Your cart is empty</div>
            </div>
        ...
        <div class="predictive__search--box ">
            <div class="predictive__search--box__inner">
                ...
                <form class="predictive__search--form" action="/shop">
                    <label>
                        <input class="predictive__search--input" placeholder="Search Here" type="text" name="q">
                    </label>
