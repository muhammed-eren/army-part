<?php
    ...
    $urun->execute([':id' => $URUN_ID]);
    $URUN = $urun->fetch(PDO::FETCH_ASSOC);

    $foto = $db->prepare("SELECT * FROM urunfoto WHERE urun_id = :id ORDER BY urunfoto_sira ASC");
    $foto->execute([':id' => $URUN_ID]);
    $FOTOLAR = $foto->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class="row row-cols-lg-2 row-cols-md-2">
                                        ...
                                        ?>
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="/<?= $FOTO['urunfoto_resimyol'] ?>"><img class="product__media--preview__items--img" src="/<?= $FOTO['urunfoto_resimyol'] ?>" alt="product-media-img"></a>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="/<?= $FOTO['urunfoto_resimyol'] ?>" data-gallery="product-media-preview">
                                        ...
                                        ?>
                                            <div class="swiper-slide">
                                                <div class="product__media--nav__items">
                                                    <img class="product__media--nav__items--img" src="/<?= $FOTO['urunfoto_resimyol'] ?>" alt="product-nav-img">
                                                </div>
                                            </div>
                                        <?php
                                  //  }
                ...
                <div class="col">
                    <div class="product__details--info">
                        <form action="#">
                            <h2 class="product__details--info__title mb-15"><?= @$URUN['urun_ad'] ?></h2>
                            <div class="product__details--info__price mb-12">
                                <span class="current__price"><?= @$URUN['urun_ozel_kod'] ?></span>
                                <span class="old__price"><?= @$URUN['urun_nato_kod'] ?></span>
                            </div>
                            <!-- Yıldız sistemi şuan kullanılmıyor -->
                            ...
                            <p class="product__details--info__desc mb-15"><?=substr($URUN['urun_detay'], 0, 200); strlen($URUN['urun_detay']) > 200 ? '...' : '';?></p>
                            <div class="product__variant">
                                <div class="product__variant--list mb-10">
                                    <fieldset class="variant__input--fieldset">
                                        <legend class="product__variant--title mb-8">Vehicle type</legend>
                                        <div class="variant__color d-flex">
                                            <?php
                                                $ARACLAR = $db->query("SELECT * FROM arac_tipi")->fetchAll(PDO::FETCH_ASSOC);
                                                foreach ($ARACLAR as $ARAC) {
                                            ?>
                                                <div class="variant__color--list">
                                                    <input id="color-red5" name="color" type="radio" <?php if($ARAC['arac_tipi_id'] == $URUN['arac_tipi_id']) echo 'checked'; else echo 'disabled'; ?>>
                                                    <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="/dimg/urun/29335216302612926572kisspng-canon-eos-650d-canon-eos-1100d-canon-eos-1200d-can-eos-5b3d8b72c2b7c8.4134576415307600507976.jpg" alt="variant-color-img"></label>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="product__variant--list mb-20">
                                    <fieldset class="variant__input--fieldset">
                                        <legend class="product__variant--title mb-8">Category</legend>
                                        <ul class="variant__size d-flex">
                                            <?php
                                                $KATEGORILAR = $db->query("SELECT * FROM kategori")->fetchAll(PDO::FETCH_ASSOC);
                                                foreach ($KATEGORILAR as $KATEGORI) {
                                            ?>
                                                <div class="variant__color--list">
                                                    <input id="cat" name="cat" type="radio" <?php if($KATEGORI['kategori_id'] == $URUN['kategori_id']) echo 'checked'; else echo 'disabled'; ?>>
                                                    <label class="variant__color--value red" for="cat" title="Red"><img class="variant__color--value__img" src="/dimg/urun/29335216302612926572kisspng-canon-eos-650d-canon-eos-1100d-canon-eos-1200d-can-eos-5b3d8b72c2b7c8.4134576415307600507976.jpg" alt="variant-color-img"></label>
                                                </div>
                                            <?php } ?>
                                        </ul>
                                    </fieldset>
                                ...
                                <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                    <div class="quantity__box">
                                        <button type="button" class="quantity__value quickview__value--quantity decrease" data-id="<?=$URUN['urun_id']?>" aria-label="quantity value" value="Decrease Value">-</button>
                                        <label>
                                            <input type="number" class="quantity__number quickview__value--number" value="1" data-counter />
                                        </label>
                                        <button type="button" class="quantity__value quickview__value--quantity increase" data-id="<?=$URUN['urun_id']?>" aria-label="quantity value" value="Increase Value">+</button>
                                    </div>
                                    <button class="primary__btn quickview__cart--btn add-to-cart" data-id="<?=$URUN['urun_id']?>" type="button">Add To Cart</button>  
                                </div>
                                <div class="product__variant--list mb-15">
                                    <button class="border-0 bg-transparent variant__wishlist--icon mb-15 add-to-wishlist" data-id="<?=$URUN['urun_id']?>" title="Add to wishlist">
                                        <?php
                                    ...
                                    <button class="variant__buy--now__btn primary__btn" type="submit">Go to cart</button>
                                </div>
                                <div class="product__variant--list mb-15">
                                    <div class="product__details--info__meta">
                                        <?php if(@$_SESSION['USER']){ ?>
                                        <p class="product__details--info__meta--list"><strong>Stock:</strong>  <span> <?php echo $URUN['urun_stok']; ?></span> </p>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="description" class="tab_pane active show">
                                <div class="product__tab--content">
                                    <div class="product__tab--content__step mb-30">
                                        <h2 class="product__tab--content__title h4 mb-10"><?$URUN['urun_ad']?></h2>
                                        <p class="product__tab--content__desc"><?=$URUN['urun_detay']?></p>
                                    </div>
                                </div> 
                            </div>
                                    ...
                                    <div class="product__tab--content__step">
                                        <ul class="additional__info_list">
                                            <li class="additional__info_list--item">
                                                <span class="info__list--item-head"><strong>Vehicle type</strong></span>
                                                <?php
                                                    $stmt = $db->query("SELECT arac_tipi_ad FROM arac_tipi WHERE arac_tipi_id = " . (int)$URUN['arac_tipi_id']);
                                                    $aracTipi = $stmt->fetch(PDO::FETCH_ASSOC);
                                                ?>
                                                <span class="info__list--item-content"><?php echo $aracTipi['arac_tipi_ad'] ?? 'Bilinmiyor'; ?></span>
                                            </li>
                                            <li class="additional__info_list--item">
                                                <span class="info__list--item-head"><strong>Category</strong></span>
                                                <?php
                                                    $stmt = $db->query("SELECT kategori_ad FROM kategori WHERE kategori_id = " . (int)$URUN['kategori_id']);
                                                    $kategori = $stmt->fetch(PDO::FETCH_ASSOC);
                                                ?>
                                                <span class="info__list--item-content"><?php echo $kategori['kategori_ad'] ?? 'Bilinmiyor'; ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div> 
